SaveCoin-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/SaveCoin/files/SaveCoin/SaveCoin-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the SaveCoin
...
New/changed settings (command-line or SaveCoin.conf file)
--------------------------------------------------------
