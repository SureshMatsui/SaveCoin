SpeedCoin-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/SpeedCoin/files/SpeedCoin/SpeedCoin-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the SpeedCoin
...
New/changed settings (command-line or SpeedCoin.conf file)
--------------------------------------------------------
