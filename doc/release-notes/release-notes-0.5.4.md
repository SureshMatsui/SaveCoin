SpeedCoin version 0.5.4 is now available for download at:
http://sourceforge.net/projects/SpeedCoin/files/SpeedCoin/SpeedCoin-0.5.4/
...
http://gitorious.org/SpeedCoin/SpeedCoind-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix SpeedCoin-Qt notifications under Growl 1.3.
Increase required age of SpeedCoin-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxSpeedCoin properly when installing SpeedCoin-Qt over it. (Windows)
