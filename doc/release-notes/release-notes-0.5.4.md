SaveCoin version 0.5.4 is now available for download at:
http://sourceforge.net/projects/SaveCoin/files/SaveCoin/SaveCoin-0.5.4/
...
http://gitorious.org/SaveCoin/SaveCoind-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix SaveCoin-Qt notifications under Growl 1.3.
Increase required age of SaveCoin-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxSaveCoin properly when installing SaveCoin-Qt over it. (Windows)
