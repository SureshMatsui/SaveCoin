...
unlocked to sign the SaveCoin-Qt.app bundle.
...
allowing somebody to distribute a SaveCoin-Qt.app or SaveCoin-qt-setup.exe with a valid
...
that the SaveCoin-qt.exe file inside the installer had not been tampered with.
