...
unlocked to sign the SpeedCoin-Qt.app bundle.
...
allowing somebody to distribute a SpeedCoin-Qt.app or SpeedCoin-qt-setup.exe with a valid
...
that the SpeedCoin-qt.exe file inside the installer had not been tampered with.
