...
#ifndef _SaveCoinRPC_CLIENT_H_
#define _SaveCoinRPC_CLIENT_H_ 1
...
/** Show help message for SaveCoin-cli.
 ...
 *
 * @note the argument can be removed once SaveCoin-cli functionality is removed from SaveCoind
 */
