...
#ifndef _SpeedCoinRPC_CLIENT_H_
#define _SpeedCoinRPC_CLIENT_H_ 1
...
/** Show help message for SpeedCoin-cli.
 ...
 *
 * @note the argument can be removed once SpeedCoin-cli functionality is removed from SpeedCoind
 */
